    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="bg-gradient-to-r from-orange-600 to-orange-700 rounded-xl p-8 text-white mb-8">
        <div className="flex items-center mb-4">
          ...
          <h1 className="text-3xl font-bold">The Factory, Round 2</h1>
        </div>
        <p className="text-orange-100">Select production method, employees, and station assignments.</p>
      </div>

      <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
        <h2 className="text-xl font-semibold text-gray-900 mb-4">Decide your factory's production method</h2>
        
        <div className="flex items-center space-x-4 mb-6">
          <div className="flex items-center">
            <span className="text-gray-700 mr-2">Each employee works:</span>
      ...
      <div className="bg-white rounded-xl shadow-lg p-6">
        <h2 className="text-xl font-semibold text-gray-900 mb-6">Additional Employee Options</h2>
        
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <span className="text-gray-700 mr-2">Would you like to offer training?</span>
              <HelpCircle className="h-4 w-4 text-gray-400" />
            </div>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <span className="text-gray-700 mr-2">Would you like to offer overtime?</span>
              <HelpCircle className="h-4 w-4 text-gray-400" />
            </div>
            <div className="flex items-center space-x-4">
              <span className="text-sm text-gray-500">No</span>
